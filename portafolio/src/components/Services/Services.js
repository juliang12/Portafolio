...
const Services = () => {
  ...
  return (
    <section className="services">
      ...
      <h1 data-aos="fade-up" className="section-title1">
        {t("header.skills")}
      </h1>
      <div data-aos="fade-up" className="bar-style"></div>
      </div>
      <div

        className="container-service"
      >
        <article data-aos="fade-up"  data-aos-delay="20" className="services-card">
          <svg
        ...
        <article data-aos="fade-up" data-aos-mirror="true"
                data-aos-once="true" data-aos-delay="300" className="services-card">
          <svg
          whileHover={{ scale: 1.1 }}
            aria-hidden="true"
            focusable="false"
        ...
        <article data-aos="fade-up" data-aos-mirror="true"
                data-aos-once="true" data-aos-delay="600" className="services-card">
          <svg
          whileHover={{ scale: 1.1 }}
            aria-hidden="true"
            focusable="false"
        ...
        <article data-aos="fade-up" data-aos-mirror="true"
                data-aos-once="true" data-aos-delay="900"  className="services-card">
          <svg
          whileHover={{ scale: 1.1 }}
            aria-hidden="true"
            focusable="false"
